...
<!-- Mirrored from htmldemo.net/flosun/flosun/product-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Dec 2022 05:03:18 GMT -->
<head>
    <meta charset="utf-8">
...
if($result->num_rows > 0) {
    while($row = $result->fetch_assoc()){
        echo "<div class='single-product-main-area'>
                            ...
                            <div class='swiper-wrapper'>
                                <div class='swiper-slide'>
                                    <a class='w-100' href='assets/images/product/large-size/1.jpg'>
                                        <img class='w-100' src='".$row['img']."' alt='Product'>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class='product-summery position-relative'>
                        ...
                        <div class='quantity-with_btn mb-5'>
                            ...
                            <div class='add-to_cart'>
                                <a class='btn flosun-button secondary-btn secondary-border rounded-0' href='delete-product.php?product_id=".$row['id']."'>Remove</a>
                            </div>
                        </div>
...
<!-- Mirrored from htmldemo.net/flosun/flosun/product-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Dec 2022 05:03:25 GMT -->
</html>