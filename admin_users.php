                           ...
                           $query = "SELECT * FROM `users`";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()){
                                    ...
                                    echo "<div><div class='shop_toolbar_wrapper mb-30'>
                                    <div class='shop_toolbar_btn'>
                                    <table>
                                    <tr>
                                        <td style='font-size:22px'>".$row['username']."</td>
                                    </tr>
                                    <tr>
                                        <td style='font-size:15px'>".$row['email']."</td>
                                    </tr>
                                    <tr>
                                        <td style='font-size:10px'>".$row['created_datetime']."</td>
                                    </tr>
                                </table>
                                    </div><form method='post' action='admin_delete-user.php?id=".$row['id']."' accept-charset='UTF-8' class='contact-form' enctype='multipart/form-data'><input type='submit' class='btn flosun-button secondary-btn theme-color rounded-0' value='Delete User'></form>
                                </div></div>";
